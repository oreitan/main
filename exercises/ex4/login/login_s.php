            ...
            <?php
                ...
                case "2":
                    ...
                    <div style ='overflow: auto; width: 300px; height:200px;'>
                        ...
                        <form action='login_s.php' method='get'
                            autocomplete ='on'>
                            <label>
                            <input type='checkbox' name='i_dont_care' value=''>
                            <input type='hidden' name='reg_un' value='3'>
                ...
                break;
                case "3":
                echo "<h2>All right the hard part in over now all that I need is your password</h2> 
                        <form>
                        <label>
                        Enter password:
                        <input type='password' name='i_dont_care' value=''>
                        <input type='hidden' name='reg_un' value='4'>
                 ...
                 case '4':
                 echo "<h2>Sorry I forget but I also need your address and phone number:</h2>
                        <form action='login_s.php' method='get'
                        autocomplete ='on'>
                        <label>
                        your address:
                        <input type='texr' name='address' value=''>
                        </label>
                        <br>
                        <label>
                        Enter phone:
                        <input type='text' name='phone' value=''>
                        <input type='hidden' name='reg_un' value='5'>
                ...
                case '5':
                echo "<h2> We are nearing the end, please
                        be patient</h2>
                        <h2>I only need a little more details</h2>
                        <form action='login_s.php' method='get'
                        autocomplete ='on'>
                        <label>
                        ...
                        <br>
                        <textarea rows='50' cols='100'>Way? in at-least 30 words</textarea>
                        <br>
                        <label>
                        ...
                        <textarea rows='50' cols='100'>Way? in at-least 30 words </textarea>
                        <br>
                        <h2>oops i forget about this one</h2> 
                        What’s The Funniest Thing You’ve Seen A Kid 
                        <br>
                        <input type='text' name='phone' value=''>
                        <input type='hidden' name='reg_un' value='6'>
                ...
                echo "<h2>plesh read: </h2>
                        ...
                        This product is licensed under the MPEG-4 Visual Patent Portfolio License for the personal and non- commercial use of a consumer for (i) encoding video </label><label>I agree<input type='checkbox' name='pure_evil4' value='evil' required></label><label>in compliance with the MPEG-4 Visual Standard (“MPEG-4 Video”) and/or (ii) decoding MPEG-4 video that was encoded by a consumer engaged in a personal and non-commercial activity and/or was obtained from a video provider licensed by MPEG LA to provide MPEG-4 video. No license is granted or shall be implied for any other use. Additional information including that relating to promotional, internal and commercial uses and licensing may be obtained from MPEG LA, LLC. See http://www.mpegla.com.
